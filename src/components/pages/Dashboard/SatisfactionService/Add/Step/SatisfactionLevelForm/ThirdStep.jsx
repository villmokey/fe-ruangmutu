      ...
      >
        <Row gutter={[24]}>
          <Col md={24} sm={24} xs={24}>
            ...
            >
              <Select disabled placeholder="Pilih Bulan" onChange={programMutuChange}>
                {
                  monthFullID &&
            ...
            >
              <Select disabled placeholder="Pilih Puskesmas" onChange={programMutuChange}>
                {
                  puskesmasList &&
            ...
            <table width={'100%'}>
              ...
              {lists && lists.map((item, index) => (
                <tr>
                  ...
                  <td>
                    <InputText disabled value={item.value} onChange={(e) => {
                      let t = [...lists];
                  ...
                  <td>
                    <InputText disabled value={item.total} onChange={(e) => {
                      let t = [...lists];
