...
export const profileQualityIndicatorActionType = {
  ...
  SET_ALL_PROFILE_QUALITY_INDICATOR:
    "profileQualityIndicator/SET_ALL_PROFILE_QUALITY_INDICATOR",
  SET_SINGLE_PROFILE_QUALITY_INDICATOR:
    "profileQualityIndicator/SET_SINGLE_PROFILE_QUALITY_INDICATOR",
  CREATE_PROFILE_QUALITY_INDICATOR:
    "profileQualityIndicator/CREATE_PROFILE_QUALITY_INDICATOR",
  UPDATE_STATUS_PROFILE_QUALITY_INDICATOR:
    "profileQualityIndicator/UPDATE_STATUS_PROFILE_QUALITY_INDICATOR",
  SET_FILE: "profileQualityIndicator/UPLOAD_FILE",
  SET_ALL_APPROVAL_PROFILE_QUALITY_INDICATOR:
    "profileQualityIndicator/SET_ALL_PROFILE_APPROVAL_QUALITY_INDICATOR",
};
...
export const getAllApprovalProfileQualityIndicator = (userID, bodyData) => {
  return {
    ...
    payload: {
      url: `${
        URL_CONFIG.PROFILE_QUALITY_INDICATOR_BASE_URL
      }/${userID}/signature${
...
export const profileQualityIndicatorSelector = ({
